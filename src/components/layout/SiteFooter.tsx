  ...
  return (
    <footer className="mt-16 border-t border-sand-200 bg-white">
      <div className="mx-auto grid max-w-content gap-8 px-4 py-12 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        ...
        <div>
          <h2 className="text-sm font-bold text-forest-700">Le service</h2>
          <ul className="mt-3 space-y-2 text-sm text-ink-soft">
            <li>
              <Link href="/#estimateur" className="hover:text-forest-600">
                Estimateur de coût
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/#realisations" className="hover:text-forest-600">
                Nos réalisations
              </Link>
            </li>
            <li>
              <Link href="/#rapport" className="hover:text-forest-600">
                Rapport détaillé
              </Link>
            </li>
          </ul>
